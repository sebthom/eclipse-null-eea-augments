...
public final class ClassGraphUtils {
	...
	/**
	 * Determines the return kind of the given method. This method distinguishes
	 * between methods that return objects, arrays, primitive types, or void.
	 *
	 * @param methodInfo the method whose return type is to be checked
	 * @return MethodReturnKind representing if the method returns an object, array,
	 *         primitive, or void
	 */
