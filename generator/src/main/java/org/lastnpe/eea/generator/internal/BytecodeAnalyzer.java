		...
		classReader.accept(new ClassVisitor(Opcodes.ASM9) {
			...
			public MethodVisitor visitMethod(final int access, final String name, final String descriptor,
				...
				return new MethodVisitor(Opcodes.ASM9) {
					...
					private boolean isKnownNonNullMethod(final String clazz, final String methodName,
						...
						return methodName.equals("<init>") //
								...
								|| clazz.equals("java/lang/String") && methodName.equals("valueOf")
										&& descriptor.equals("(Ljava/lang/Object;)Ljava/lang/String;") //
								|| clazz.equals("java/lang/StringBuilder")
										&& (methodName.startsWith("append") || methodName.startsWith("insert")) //
								|| clazz.equals("java/lang/invoke/StringConcatFactory")
										&& methodName.startsWith("makeConcat");
					}
					...
					public void visitInsn(final int opcode) {
						...
						case Opcodes.ARETURN:
							if (operandStackNullability.isEmpty()) {
								...
								/*
								 * handle: if (arg1 == null) return null;
								 *
								 * which translates to: [ALOAD 0, IFNONNULL, ACONST_NULL, ARETURN]
								 *
								 * or: if (arg1 == null) return arg1;
								 *
								 * which translates to: [ALOAD 0, IFNONNULL, ALOAD 0, ARETURN]
								 */
					...
					public void visitLdcInsn(final Object constant) {
						...
						if (constant instanceof Integer || constant instanceof Float //
							...
							// primitive constants, string constants, class literals, method handles are
							// non-null
					...
					public void visitInvokeDynamicInsn(final String name, final String descriptor,
							final Handle bootstrapMethodHandle, final Object... bootstrapMethodArgs) {
						visitMethodInsn(Opcodes.INVOKEDYNAMIC, bootstrapMethodHandle.getOwner(), name, descriptor,
					...
					public void visitMethodInsn(final int opcode, final String owner, final String name,
						...
						debugLogVisit(
								"visitMethodInsn " + Textifier.OPCODES[opcode] + " " + owner + "." + name + descriptor);
						instructions.add(new Instruction(opcode));
					...
					public void visitVarInsn(final int opcode, final int varIndex) {
						...
						case Opcodes.ALOAD:
							...
							final var varNullability = localVariableNullability.getOrDefault(varIndex,
									Nullability.UNKNOWN);
